...
public class GetFavoritesRemoteOperationTest extends AbstractIT {
    ...
    public void noFavorites() {
        GetFavoritesRemoteOperation sut = new GetFavoritesRemoteOperation(userId);
    ...
    public void oneFavorite() {
        ...
        // clean up
        assertTrue(new ToggleFavoriteRemoteOperation(false, path, userId).execute(client).isSuccess());
